...
- ./p0_with_debug.ml is a version of P0 with extra state info, for
  debugging

- ./abnf_grammar.txt is a handwritten grammar used for parsing ABNF
  format files

- ./parse_abnf_grammar_txt.ml parses this file and generates
  abnf_grammar.sexp
  
- ./generate_abnf_parser.ml then takes the result and generates a
  parser for ABNF format files
